...
- **Omschrijving:** Uitvoeren van GraphQL-query [QLR-0002-ZA.graphql](@@@) op het Leveringsregister door een aanbieder.
...
### Resultaat
> Toegang tot het Leveringsregister via query [QLR-0002-ZA](@@@) is **alleen toegestaan** als:
