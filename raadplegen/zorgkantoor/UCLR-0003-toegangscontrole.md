...
- **Omschrijving:** Uitvoeren van GraphQL-query [QLR-0003-ZK](@@@) op het Leveringsregister door een zorgkantoor.
...
### Resultaat
> Toegang tot het Leveringsregister via query [QLR-0003-ZK](@@@) is alleen toegestaan als:
