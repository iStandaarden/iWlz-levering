...
- **Beperking:** Alleen toegang tot gegevens van de Uitstelperiode (en overige informatie) waarvoor het zorgkantoor:
  1. Aan te merken is als het uitvoerend zorgkantoor voor de Bemiddelingspecificatie waaraan de Uitstelperiode via Levering is gekoppeld;
  2. Aan te merken is als een verantwoordelijk zorgkantoor, die betrokken is bij dezelfde Bemiddeling waaronder de Bemiddelingspecificatie valt waaraan de Uitstelperiode via Levering is gekoppeld. 
